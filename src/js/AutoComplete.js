class AutoComplete {
    ...
    _serchResultMake() {
        ...
        this.filterData.map((item) => {
            ...
            /*값 추가*/
            searchResultLi.setAttribute("onclick", "input_ch(\'" + liInnerHtml + "\')");
        });
